...
public class GenerateFireReport {
	...
	public static void main(String[] args) throws Exception {
		...
		ReportGenerator<FireData> generator = ReportGenerator.<FireData>withTemplateBuilder(templateBuilder)
				.withReplacer(new ReplaceWithMap<>(new FireImageTransformer()))
				.withReplacer(new ReplaceWithChart<>(new FireChartMaker()));

		generator.generate(FIRE_REPORT_TYPE, new FireData(), new File("fire-img.pdf"));
	}
